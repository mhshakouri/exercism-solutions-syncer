...
def approx_average_is_average(hand):
    ...
    return average in (hand[middle_index], first_and_last_average)
...
def average_even_is_average_odd(hand):
    ...
    """
    evens = [hand[index] for index in range(len(hand)) if index % 2 == 0]  # even indices
    odds = [hand[index] for index in range(len(hand)) if index % 2 != 0]   # odd indices
